...
class PlayfulEmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget firstBubble = _Bubble(
      size: 34,
      color: AppPalette.sunshine.withValues(alpha: 0.78),
    );
    Widget secondBubble = _Bubble(
      size: 28,
    ...
    if (!reduceMotion) {
      ...
      iconTile = iconTile.animate().scale(
    ...
    final Widget messageWidget = ConstrainedBox(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ExcludeSemantics(
                child: SizedBox(
                  ...
                  child: Stack(
                    ...
                    children: <Widget>[
                      Positioned(left: 8, top: 10, child: firstBubble),
                      Positioned(right: 5, bottom: 8, child: secondBubble),
                      iconTile,
                    ],
                  ),
                ),
              ...
              reduceMotion
                  ? messageWidget
                  : messageWidget.animate().fadeIn(delay: 180.ms),
